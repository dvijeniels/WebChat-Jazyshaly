jQuery(document).ready(function($){
	var $form_modal = $('.cd-user-modal'),
		$form_modal_date_filter = $('.cd-user-modal-date-filter'),
		...
		$main_nav = $('.main-nav'),
		$onclick_date_filter = $('.onclick-date-filter');
	...
	$onclick_date_filter.on('click', function (event) {
			$form_modal_date_filter.addClass('is-visible');
	});
	...
	$('.cd-user-modal-date-filter').on('click', function (event) {
		if ($(event.target).is($form_modal_date_filter) || $(event.target).is('.cd-close-form')) {
			$form_modal_date_filter.removeClass('is-visible');
		}
	});
